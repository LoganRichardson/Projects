...
import static com.raadz.program.raadzandroid.R.drawable.account;
import static com.raadz.program.raadzandroid.R.id.bGoogleSignIn;
import static com.raadz.program.raadzandroid.R.id.view;

public class RegisterActivity extends AppCompatActivity implements AsyncResponse, View.OnClickListener, DialogInterface, GoogleApiClient.OnConnectionFailedListener {
    ...
    String RegisterURL = "https://raadz.com/usersignup.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAdvertiser = (TextView) findViewById(R.id.tvAdvertiser);
        ...
        tvAdvertiser.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                GraphRequest request = GraphRequest.newMeRequest(loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        ...
                        if (accExists = false) {
                            ...
                            edit.putString("adv_or_user", "user");
                            edit.commit();

                            Intent in = new Intent(RegisterActivity.this, FragActivity.class);
                            startActivity(in);
                        }
                        if (accExists = true) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!etPassword.getText().toString().equals(etPasswordRepeat.getText().toString())) {
                    ...
                    Toast.makeText(RegisterActivity.this, "First name cannot be blank", Toast.LENGTH_SHORT).show();
                    Log.d("first ", etFirst.getText().toString());
                } else if (etLast.length() < 1) {
                    Toast.makeText(RegisterActivity.this, "Last name cannot be blank", Toast.LENGTH_SHORT).show();
                    ...
                    if (CheckEditText) {
                        ...
                        edit.commit();
                        SendDataToServer(EmailHolder, PasswordHolder, PasswordRepeatHolder, FirstHolder, LastHolder, LastReferrer);
                    } else {
...
*/
    ...
    public void GetCheckEditTextIsEmptyOrNot() {
        ...
        LastReferrer = etReferral.getText().toString();
    ...
    public void FacebookLoginFunction(final String raadz_user_id, final String email, final String firstname, final String lastname, final String token) {
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                Log.d("PostResultFacebook ", result);
                if (result.contains("invalid access token")) {
                    ...
                    Toast.makeText(RegisterActivity.this, "Signup Disabled", Toast.LENGTH_SHORT).show();
    ...
    public void SendDataToServer(final String email, final String password, final String passwordre, final String first, final String last, final String refer) {
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            @Override
            protected String doInBackground(String... params) {
                ...
                nameValuePairs.add(new BasicNameValuePair("referrer", QuickReferrer));
            ...
            protected void onPostExecute(String result) {
                ...
                if (result.contains("Message could not be sent")) {
                    success = "0";
                    Toast.makeText(RegisterActivity.this, "Message could not be sent", Toast.LENGTH_SHORT).show();
                    ...
                    success = "0";
                    Toast.makeText(RegisterActivity.this, "Message has been sent", Toast.LENGTH_SHORT).show();
                    ...
                    mBack.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            dialog.dismiss();
                            Intent browserIntent = new Intent(RegisterActivity.this, LoginActivity.class);
                            startActivity(browserIntent);
                        }
                    });
                    mToEmail.setOnClickListener(new View.OnClickListener() {
        ...
        SendPostReqAsyncTask sendPostReqAsyncTask = new SendPostReqAsyncTask();
        sendPostReqAsyncTask.execute(first, last, email, password, passwordre, refer);
    }
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    HttpClient httpClient = new DefaultHttpClient();
                    HttpPost httpPost = new HttpPost(GoogleUserSignUpURL);
                    httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
                    HttpResponse response = httpClient.execute(httpPost);
                    HttpPost request = new HttpPost(GoogleUserSignUpURL);
                    UrlEncodedFormEntity entity = new UrlEncodedFormEntity(nameValuePairs);
                    request.setEntity(entity);
            ...
            protected void onPostExecute(final String result) {
                ...
                if (result.contains("Message has been sent")) {
                    ...
                    Toast.makeText(RegisterActivity.this, result + ": " + "please sign in.", Toast.LENGTH_SHORT).show();
                    signOut();
                    Intent in = new Intent(RegisterActivity.this, LoginActivity.class);
                    startActivity(in);
