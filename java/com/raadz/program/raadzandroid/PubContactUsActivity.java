...
public class PubContactUsActivity extends AppCompatActivity implements AsyncResponse, View.OnClickListener, DialogInterface,NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pub_contact_us);
        ...
        ibProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(PubContactUsActivity.this, PubProfileActivity.class);
                startActivity(in);
            }
        });
            ...
            case R.id.action_logout:
                ...
                mEnter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent in = new Intent(PubContactUsActivity.this, IndexActivity.class);
                        startActivity(in);
                    }
                });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == adv_home) {
            ...
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(PubContactUsActivity.this);
    ...
    public void processFinish(String s) {
        ...
        Intent in = new Intent(PubContactUsActivity.this, FragPubActivity.class);
        startActivity(in);
    }
}
