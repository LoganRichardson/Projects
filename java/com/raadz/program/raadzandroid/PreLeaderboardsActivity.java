...
import static com.raadz.program.raadzandroid.R.id.tvfCity;
import static com.raadz.program.raadzandroid.R.id.tvfEarningsHistOther;
import static com.raadz.program.raadzandroid.R.id.tvfUser;
import static com.raadz.program.raadzandroid.R.id.view;

public class PreLeaderboardsActivity extends YouTubeBaseActivity implements AsyncResponse, View.OnClickListener, DialogInterface, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_leaderboards);
...
//        altView = tvTopEarners;
        ...
        ArrayAdapter<String> boardsU = new ArrayAdapter<String>(PreLeaderboardsActivity.this, android.R.layout.simple_spinner_item, Ulist);
        ...
        ArrayAdapter<String> boards = new ArrayAdapter<String>(PreLeaderboardsActivity.this, android.R.layout.simple_spinner_item, Llist);
...
//        dialog.show(getFragmentManager(), "LeaderboardActivityUser");
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(PreLeaderboardsActivity.this);
...
//        dialog.show();
    ...
    public void onClick(View v) {
        ...
        Log.d("lastValue ", lastValueSelected);
        Log.d("lastTime ", lastTimeValueSelected);
        Log.d("lastLocation ", lastLocationValueSelected);
        Log.d(" - ", " - ");
        colorChanger = 0;
