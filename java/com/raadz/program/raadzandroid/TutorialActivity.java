    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(TutorialActivity.this, AdsHistory.class);
                startActivity(in);
            }
        });
        ...
        bNext6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(TutorialActivity.this, FragActivity.class);
                startActivity(in);
            }
        });
            ...
            case R.id.action_logout:
                ...
                mEnter.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent in = new Intent(TutorialActivity.this, IndexActivity.class);
                        startActivity(in);
                    }
                });
