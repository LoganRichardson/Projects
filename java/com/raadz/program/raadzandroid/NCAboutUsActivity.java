...
public class NCAboutUsActivity extends AppCompatActivity implements AsyncResponse, View.OnClickListener, DialogInterface,NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ncabout_us);
        ...
        if (id == nc_nav_leaderboards) {
            ...
            mEnter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(NCAboutUsActivity.this, IndexActivity.class);
                    startActivity(in);
                }
            });
            ...
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(NCAboutUsActivity.this);
