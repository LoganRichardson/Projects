...
import static com.raadz.program.raadzandroid.R.id.bAddResults;
import static com.raadz.program.raadzandroid.R.id.sLocation;

public class NCLeaderboardsActivity extends YouTubeBaseActivity implements AsyncResponse, View.OnClickListener, DialogInterface, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ncleaderboards);
...
//        }
        ...
        ArrayAdapter<String> boardsU = new ArrayAdapter<String>(NCLeaderboardsActivity.this, android.R.layout.simple_spinner_item, Ulist);
        ...
        ArrayAdapter<String> boards = new ArrayAdapter<String>(NCLeaderboardsActivity.this, android.R.layout.simple_spinner_item, Llist);
...
//        dialog.show(getFragmentManager(), "LeaderboardActivityUser");
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(NCLeaderboardsActivity.this);
        ...
        if (id == R.id.nc_nav_home) {
            ...
            mEnter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(NCLeaderboardsActivity.this, IndexActivity.class);
                    startActivity(in);
                }
            });
